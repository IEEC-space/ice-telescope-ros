...
\section{Description}
%%%%%%%%%%%%%%%%%%%%%
\Prog{ice\_telescope} is composed of several nodes --\Prog{ice\_telescope\_node}-- that allow the control of the telescope system. In addition to the server to control all devices \Prog{ice\_tel\_server}, each of the system components (telescope, dome, ccd) has a pair of client--server nodes following the naming convention \Prog{brand\_server} and \Prog{brand\_client}: 
...
\item[Copyright] \copyright\ 2015, Biel Artigues Aguilo,
     ...
     \URL{https://baiels.redkaos.org/index.php/s/H4i9a87jyLQ4BMc}.
